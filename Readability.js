...
Readability.prototype = {
  ...
  REGEXPS: {
    ...
    unlikelyCandidates:
      /-ad-|ai2html|breadcrumbs|combx|comment|community|cover-wrap|disqus|extra|footer|gdpr|legends|menu|related|remark|replies|rss|shoutbox|sidebar|skyscraper|social|sponsor|supplemental|ad-break|agegate|pagination|pager|popup|yom-remote/i,
    okMaybeItsACandidate: /and|article|body|column|content|main|shadow|price/i,

    positive:
      /article|authors|author|body|content|entry|hentry|h-entry|main|page|pagination|post|text|blog|story|news|price/i,
    negative:
  ...
  _grabArticle: function (page) {
    ...
    while (true) {
      ...
      var siblingScoreThreshold = Math.max(
        1,
        topCandidate.readability.contentScore * 0.1
      );
